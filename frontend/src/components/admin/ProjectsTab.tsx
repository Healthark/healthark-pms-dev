...
// page and <main> scrolls — so the header is NOT sticky (page-level sticky is
// unreliable under <main>'s `zoom: 0.9`). Opaque background + per-cell bottom
// border (a <tr> border would not show under border-separate). Mirrors UsersTab.
